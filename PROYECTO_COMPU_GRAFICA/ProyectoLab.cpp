...
std::string rtSkybox = "Textures/Skybox/sgod_rt.tga";
std::string lfSkybox = "Textures/Skybox/sgod_lf.tga";
std::string dnSkybox = "Textures/Skybox/sgod_dn.tga";
std::string upSkybox = "Textures/Skybox/sgod_up.tga";
std::string bkSkybox = "Textures/Skybox/sgod_bk.tga";
std::string ftSkybox = "Textures/Skybox/sgod_ft.tga";
		...
		if (horario) {
			if (dia)
			{
				...
				if (nocheCont > 200)
				{
					...
					rtSkybox = "Textures/Skybox/Noche3/sgod_noche3_rt.tga";
					lfSkybox = "Textures/Skybox/Noche3/sgod_noche3_lf.tga";
					dnSkybox = "Textures/Skybox/Noche3/sgod_noche3_dn.tga";
					upSkybox = "Textures/Skybox/Noche3/sgod_noche3_up.tga";
					bkSkybox = "Textures/Skybox/Noche3/sgod_noche3_bk.tga";
					ftSkybox = "Textures/Skybox/Noche3/sgod_noche3_ft.tga";
			...
			if (noche)
			{
				...
				if (diaCont > 200)
				{
					...
					rtSkybox = "Textures/Skybox/sgod_rt.tga";
					lfSkybox = "Textures/Skybox/sgod_lf.tga";
					dnSkybox = "Textures/Skybox/sgod_dn.tga";
					upSkybox = "Textures/Skybox/sgod_up.tga";
					bkSkybox = "Textures/Skybox/sgod_bk.tga";
					ftSkybox = "Textures/Skybox/sgod_ft.tga";
